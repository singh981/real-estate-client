 ...
 * Sets up API endpoints for data fetching and mutations
 * Provides hooks for components to interact with the backend
 */
		...
		getAuthUser: build.query<User, void>({
			queryFn: async (_, _queryApi, _extraoptions, fetchWithBQ) => {
				try {
					...
					// Return error in the format expected by RTK Query
